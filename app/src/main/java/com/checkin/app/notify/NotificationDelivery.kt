 ...
 * set to "None". Getting it wrong is not merely bad analytics — the session reminder marks its alert
 * spent on the strength of this answer, so the first reminder the user can actually read would arrive
